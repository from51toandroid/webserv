...
public class HttpFBHandler implements HttpRequestHandler {
    ...
    private String TAG = "HttpFBHandler";
    ...
    public void handle(HttpRequest request, HttpResponse response, HttpContext context)
        ...
        //Log.i( TAG, "request.getRequestLine() = " + request.getRequestLine() );
        //Log.i( TAG, "request.getRequestLine().getUri() = " + request.getRequestLine().getUri() );
        //Log.i( TAG, "Config.SERV_ROOT_DIR = " + Config.SERV_ROOT_DIR );
        //Log.i( TAG, "this.webRoot = " + this.webRoot );
        if (target.equals("/")) {
