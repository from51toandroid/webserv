...
public final class MECARDContactEncoder extends ContactEncoder {
    ...
    private static final Formatter MECARD_FIELD_FORMATTER = new Formatter() {
        ...
        public String format(String source) {
            return NEWLINE.matcher(RESERVED_MECARD_CHARS.matcher(source).replaceAll("\\\\$1"))
                    .replaceAll("");
        }
    };
    ...
    private static void append(StringBuilder newContents, StringBuilder newDisplayContents,
    ...
    private static void appendUpToUnique(StringBuilder newContents,
            ...
            Formatter formatter) {
        doAppendUpToUnique(newContents, newDisplayContents, prefix, values, max, formatter,
