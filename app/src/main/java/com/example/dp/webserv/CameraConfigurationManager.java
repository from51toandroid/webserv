...
import com.example.dp.webserv.CaptureActivity;
import com.example.dp.webserv.ZXingPreferences;
...
final class CameraConfigurationManager {
    ...
    void setDesiredCameraParameters(Camera camera, boolean safeMode) {
        ...
        if (prefs.getBoolean(ZXingPreferences.KEY_AUTO_FOCUS, true)) {
            if (safeMode || prefs.getBoolean(ZXingPreferences.KEY_DISABLE_CONTINUOUS_FOCUS, false)) {
        ...
        if (prefs.getBoolean(ZXingPreferences.KEY_INVERT_SCAN, false)) {
