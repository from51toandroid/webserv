...
import com.example.dp.webserv.WSApplication;
/**
 * @brief 通用工具
 * @author join
 */
public class CommonUtil {
     ...
     */
    public String getLocalIpAddress_src() {
        try {
            // 遍历网络接口
    ...
    public final String TAG = "CommonUtil";
    ...
    public void stack_dump() {
        RuntimeException e = new RuntimeException("debug info is here:");
        e.fillInStackTrace();
        Log.d( TAG, ""+ this, e );
    }
